    ...
    return (
        <StyledContainer className={'d-flex flex-column justify-content-center vh-100'}>
            ...
            <Row className="justify-content-center mb-3">
                <Col xs={6} sm={4} lg={3}>
                    <Button variant={'link'} className="p-0" data-cy="login-btn"
                            onClick={() => setIsSignUp(false)}>Sign in</Button>
                </Col>
                <Col xs={6} sm={4} lg={3} className="d-flex justify-content-end">
                    <Button variant={'link'} className="p-0" data-cy="signup-btn"
            ...
            <Row className="justify-content-center">
                ...
                <Col xs={12} sm={8} lg={6}>
                    <Form onSubmit={handleSubmit} data-cy="authentication-form">
                        <Form.Group className="mb-3">
                            <Form.Label>Email address</Form.Label>
                            <Form.Control type="email" placeholder="Enter email"
                                          value={email} data-cy="email"
                                          isValid={validEmail}
                        ...
                        {isSignUp && (
                            <Form.Group className="mb-3">
                                ...
                                <Form.Control type="username" placeholder="Enter a username"
                                              value={username} data-cy="username"
                        ...
                        <Form.Group className="mb-3">
                            ...
                            <Form.Control type="password" placeholder="Enter password"
                                          value={password} data-cy="password"
                                          min={6}
